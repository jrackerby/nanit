"""Tests for aionanit_jr.ws.protocol — protobuf encode/decode helpers."""

from __future__ import annotations

import pytest

from aionanit_jr.exceptions import NanitProtocolError
...
from aionanit_jr.ws.protocol import (
    build_keepalive,
    build_request,
    decode_message,
    encode_message,
